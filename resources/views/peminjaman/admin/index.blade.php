    ...
    <div class="card card-outline card-primary">
        <div class="card-header form-inline">
            <div class="input-group">
                <select id="pegawai" class="form-control" data-live-search="true" data-style="btn-secondary">
        ...
        <div class="card-body p-0">
            <table class="table table-hover table-striped m-0">
                ...
                <tbody>
                    <?php $no = $peminjamans->firstItem()?>
                    @foreach ( $peminjamans as $peminjaman )
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>
                            <a href="{{ route('admin.peminjaman.info',['peminjaman'=>$peminjaman->id]) }}">
                        ...
                        <td class="text-right">
                            <x-info href="{{ route('admin.peminjaman.info',['peminjaman'=>$peminjaman->id]) }}"/>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
